...
export class ItemService {
    ...
    constructor(
        ...
        // private setMyTestService: SetMyTestService,
    ) { }
    ...
    public getSearchResult(value: string) {
        const headers = new Headers({ "X-Algolia-Application-Id": "4QKIXJO05X", "X-Algolia-API-Key": "a51cc96cfa7f7ab34d0c9d00f13d79f1" });
        ...
        this.http.get("https://4QKIXJO05X-dsn.algolia.net/1/indexes/trialQuestions?query=" + valueSent, options)
            ...
            .do((result) => console.log("HALLELUAH! THE SEARCH IS RETURNED FOR : " + valueSent))
            .subscribe((result) => {
                const self = this;
                const myArray = [];
